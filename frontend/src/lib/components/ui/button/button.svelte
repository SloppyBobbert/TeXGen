  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        outline:
          "border-border bg-background hover:bg-muted hover:text-foreground dark:border-border dark:bg-background dark:hover:bg-muted/50 aria-expanded:bg-muted aria-expanded:text-foreground",
        secondary:
...
{#if href}
  <a
    ...
    href={!disabled ? resolve(href) : undefined}
